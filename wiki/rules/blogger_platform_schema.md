...
### 1.3 theme (사이트 테마 템플릿 자산)
- **Blogger 종합 테마 XML**: [`wiki/theme/blogger_site_theme.xml`](file:///d:/coding-project/2026-project/ai-blogging/wiki/theme/blogger_site_theme.xml)
  * 대시보드 드래그 앤 드롭 가젯 호환 구조
- **글 본문 CSS 스타일시트**: [`wiki/theme/blogger_post_style.css`](file:///d:/coding-project/2026-project/ai-blogging/wiki/theme/blogger_post_style.css)
