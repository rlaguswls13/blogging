...
def manage_theme(upload: bool = False):
    ...
    theme_path = project_root / "templates" / "blogger_site_theme.xml"
    ...
    if not upload:
        ...
        # 백업 생성
        backup_dir = project_root / "templates" / "backups"
        ...
        try:
            ...
            print(f"[성공] 테마 백업 완료: templates/backups/{backup_path.name}")
